				...
				<div className='flex flex-col justify-center gap-4 rounded-xl bg-[#2a2a2a] p-4 my-5'>
					...
					<div className='flex justify-betweeen items-center w-full'>
						<div className='flex items-center gap-5 w-3/4'>
							<Image alt='pfp' className='size-20 rounded-full' src={pfp} />
							<div className='flex flex-col justify-center'>
								<h1 className='text-lg font-bold'>Sambit Singha</h1>
								<p className='text-sm font-medium text-gray-200'>Front-end developer</p>
							</div>
							<div className='flex flex-col justify-center'>
								<h1 className='text-lg text-gray-300'>Time</h1>
								<p className='text-sm font-bold'>10:30 am - 11:30 am</p>
							</div>
						</div>
				...
				<div className='grid layout my-5'>
					<div className='flex flex-col gap-4 rounded-xl bg-[#2a2a2a] p-4 h-auto'>
						<div className='flex items-center gap-2'>
							...
							<h1 className='font-medium text-lg'>Current Vacancies</h1>
						</div>
						<div className='grid grid-cols-2 gap-4'>
							<div className='flex justify-between items-center gap-4 rounded-xl border border-white py-2 px-4'>
								<h1 className='font-semibold text-sm'>Marketing Specialist</h1>
								<div className='flex justify-center items-center gap-2'>
									<User size={24} />
									<h1 className='text-sm'>1/4 recruited</h1>
								</div>
							</div>
							<div className='flex justify-between items-center gap-4 rounded-xl border border-white py-2 px-4'>
								<h1 className='font-semibold text-sm'>Financial Analyst</h1>
								<div className='flex justify-center items-center gap-2'>
									<User size={24} />
									<h1 className='text-sm'>3/4 recruited</h1>
								</div>
							</div>
						</div>
					</div>
					...
					<div className='flex flex-col gap-4 rounded-xl bg-[#2a2a2a] p-4 h-auto'>
						<div className='flex items-center gap-2'>
							<User size={24} />
							<h1 className='font-medium text-lg'>Potential Candidates</h1>
						</div>
						<Table>
							<TableHeader>
								<TableRow>
									<TableHead className='w-40 text-white font-medium'>Name</TableHead>
									<TableHead className='text-white font-medium'>Location</TableHead>
									<TableHead className='text-white font-medium'>Preferred Job</TableHead>
					...
					<div className='flex flex-col gap-4 rounded-xl bg-[#2a2a2a] p-4 h-auto'>
						<div className='flex items-center gap-2'>
							<Globe2 size={24} />
							<h1 className='font-medium text-lg'>Countries Insight</h1>
						</div>
