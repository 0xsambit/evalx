        ...
        <section className='flex flex-col justify-center item-center w-full h-full bg-primary text-white font-roboto'>
            ...
            <div className='section'>
                ...
                <form className='flex flex-col justify-center items-start px-10'>
                    <h1 className='text-xl font-medium'>Skills / Expertise</h1>
                    {skills.map((skill) => (
                        <div
                            className='flex  justify-center items-center gap-5 h-10'
                            key={skill.id}>
                            <Checkbox label={skill.code} className='bg-white' />
            ...
            <div className='flex justify-center items-center m-auto w-full'>
                <Button className='bg-white text-black font-medium text-lg rounded-xl w-3/4 hover:bg-black hover:text-white duration-200 ease-linear'>
                    Submit
                </Button>
            </div>
        </section>
